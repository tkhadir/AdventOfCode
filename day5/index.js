...
const opcode_affectation = 3
const opcode_produce = 4
...
let workV3 = (data, noun, verb, goal) => {
    //console.log('initial data : ' + data)
    let solution = cloneArr(data)
    solution[1] = noun
    solution[2] = verb
...
const part2 = 2
const part3 = 3
let solvePart = process.argv.slice(2)[0] ? process.argv.slice(2)[0] : part1

console.log('solving part : ' + solvePart)
console.log('found solution : ------------------')
if (solvePart == part3) {
    solveV3(inputs)
} else if (solvePart == part2) {
    solveV2(inputs)
} else {
    solve(inputs)
}
